...
class OS
  ...
  def initialize(cfg)
    ...
    @pkgs = %w[
      ...
      htop imagemagick mc mosh most ncdu npm nnn python syncthing tmux vifm vim
      wget zsh zsh-syntax-highlighting
    ]
  ...
  def self.extended(mod)
    ...
    (
      mod.pkgs << %w[
        ...
        keepassxc keepingyouawake kitty lolcat nmap spectacle sublime-text
        syncthing-app telegram typora vanilla virtualbox visual-studio-code vox
        watch xquartz
      ]
    ).flatten!
