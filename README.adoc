...
{url-cv}[David Rabkin] maintains this repository of personal dotfiles. It
holds configuration for the shell, Git, tmux, and other everyday tools,
together with an installer that puts everything in place.
...
Sergey Matveev's {url-goredo}[`goredo`] provides a compatible implementation.
`redo lint` runs the following linters:
